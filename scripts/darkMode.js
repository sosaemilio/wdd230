...
modeButton.addEventListener("click", () => {
	if (modeButton.src.includes("dark-mode-icon.svg")) {
		...
		submitBtn.style.background = "#323232";
		submitBtn.style.color  = "#fff";
		submitBtn.style.border = "#323232";
		...
		submitBtn.style.background = "#DDD0C8";
		submitBtn.style.color = "#323232";
		submitBtn.style.border = "solid var(--secondary-color)";
		links.forEach((link) => {
